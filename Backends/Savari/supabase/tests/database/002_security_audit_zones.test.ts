...
Deno.test("Savari security migration keeps evidence and client business data constrained", async () => {
  ...
  for (
    const contract of [
      ...
      "'savari-evidence', 'savari-evidence', false",
      "create policy savari_evidence_select_own",
      "create policy savari_evidence_insert_own",
      "create policy savari_evidence_update_own",
