...
select c.id,'Sesame & Gingelly Oil','sesame-oil','DRAFT'::dastak_v1.catalogue_status,
...
where ct.slug='staples-pantry' and c.slug='cooking-oils'
  and not exists (select 1 from dastak_v1.subcategories s where s.category_id=c.id and s.slug='sesame-oil');;
