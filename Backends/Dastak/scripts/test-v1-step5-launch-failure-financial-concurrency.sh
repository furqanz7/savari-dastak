...
('99600000-0000-4000-8000-000000000304'::uuid,'delivery.default_sku_logistics','{"weightGrams":500,"lengthMillimetres":200,"widthMillimetres":100,"heightMillimetres":100,"temperatureClass":"AMBIENT","fragile":false,"bulky":false}'::jsonb),
('99600000-0000-4000-8000-000000000305'::uuid,'delivery.transport_load_profiles','[{"transportType":"MOTORBIKE","maxWeightGrams":50000,"maxVolumeCubicMillimetres":500000000,"maxLongestSideMillimetres":1500,"allowsBulky":true,"temperatureClasses":["AMBIENT","CHILLED","FROZEN"]}]'::jsonb),
