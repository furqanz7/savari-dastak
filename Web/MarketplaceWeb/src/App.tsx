...
export default function App() {
  ...
  return (
    <main className={`app product-${config.product} variant-${config.variant}${usesCustomerOnboarding ? " customer-onboarding-active" : ""}`}>
      {!usesFullDastakAuth && !(["dastak-admin", "dastak-customer", "dastak-merchant", "dastak-delivery"].includes(config.variant) && view.phase === "ready") && <header className="topbar" aria-hidden={showsDastakLaunch || undefined}>
        <Brand />
