...
begin
  ...
  where table_type = 'BASE TABLE'
    ...
    and (
      has_table_privilege('authenticated', format('%I.%I', table_schema, table_name), 'DELETE')
      or (
        (has_table_privilege('authenticated', format('%I.%I', table_schema, table_name), 'INSERT')
